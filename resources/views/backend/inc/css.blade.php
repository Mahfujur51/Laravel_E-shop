 <!-- plugins:css -->
    ...
    <link rel="stylesheet" href="{{asset('backend/vendors/iconfonts/ionicons/css/ionicons.css')}}">
    <link rel="stylesheet" href="{{asset('backend/vendors/iconfonts/typicons/src/font/typicons.css')}}">
